package com.example.sanyog.presentation.welcomescreen
...
fun WelcomeScreen(navHostController: NavHostController) {
    ...
    Column(
        ...
        Image(
            painter = painterResource(id = R.drawable.sanyog_removebg),
            contentDescription = null,
            modifier = Modifier.size(300.dp)
        )

        Text(text = "Welcome to Sanyog", fontSize = 24.sp, fontWeight = FontWeight.Bold)
